...
import webview  # For displaying Razorpay checkout in a webview
...
class Kishore(MDApp):
    ...
    def pay_now(self):
        ...
        It creates an order on Razorpay and opens Razorpay checkout in a webview.
        """
        ...
        if order_data:
            ...
            # Save the HTML content to a local file and open it in a webview
    ...
    def open_payment_modal(self, html_content):
        ...
        and open it in the system's webview with a custom window size.
        ...
        try:
            # Open the Razorpay checkout page inside the webview window
